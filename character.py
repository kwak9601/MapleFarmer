...
class Character:
    ...
    def teleport(self, direction=None, key="a"):
    ...
    def move_to(self, x, y=None, relative=True, x_threshold=X_THRESHOLD, y_threshold=Y_THRESHOLD):
        ...
        if y is None:
            ...
            x = x[0]
        not_move_count = 0
        direction, teleport, jump, (last_x, last_y) = self.get_target_direction(x, y, relative, x_threshold, y_threshold)
        while direction != Direction.NONE:
            ...
            direction, teleport, jump, (now_x, now_y) = self.get_target_direction(x, y, relative, x_threshold, y_threshold)
    ...
    def key_reset(self):
        ...
        window.activate()
        window.wait_active()
        for k in ["l", "j", "F1", "F2", "r", "a", "s", "e", "1", "2", "3", "4", "9", "F7", "F8", "F3", "F4", "d", "PgDn", "LShift"]:
    ...
    def buff_up(self):
        ...
        self.use_skill("PgDn")
        time.sleep(random.randint(100, 110) / 100)
...
if __name__ == "__main__":
    ...
    jobs = {
        ...
        #     "func": use_domain,
        #     "cd": 210,
        #     "last": time.time() - 120 - 15,
        #     # "last": None,
        #     "args": [Target.DOMAIN_DIRECTION]
        # },
        "mesos": {
            "func": get_mesos,
            "cd": 90,
    ...
    # buff()
    # place_kishin()
    # use_exo(Target.SHIKI_DIRECTION)
    # place_boss(Target.BOSS_DIRECCTION)
    # #
    # use_domain(Target.DOMAIN_DIRECTION)
    # get_mesos()
    #
    ...
    #     # char.move_to(Target.EXO_POSITION)
    #     char.use_exo()
    #     time.sleep(random.randint(180, 230) / 1000)
    #     char.use_shiki()
    ...
    # window = char.get_maple_window()
    # region = (window.position[0],
    #           window.position[1] + window.height - RESOLUTION[1]) + RESOLUTION
    # image = pyautogui.screenshot(region=region).convert(mode="RGB")
    # open_cv_image = numpy.array(image)[:, :, ::-1].copy()
    ...
    #     print(f"Prediction: {result}")
    #
    # # can randomize  windowPosition = (33, 152)
    # # random_points = [(202, 273), (58, 272), (74, 239), (158, 253)]
    # random_points = [(169, 121), (25, 120), (41, 87), (135, 101)]  # relative
    # random.shuffle(random_points)
    # # destinations = [(95, 258)] + random_points +  [(95, 258)]
    # destinations = [(62, 106)] + random_points + [(62, 106)]  # relative
    # # for destination in destinations:
    # #     print(f"moving to {destination}")
    # #     char.move_to(destination, relative=True)
    # #
    #
    #
